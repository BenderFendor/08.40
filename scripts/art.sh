...
# I have no idea how bash really works so this is my hack to try and get it to work so yeah

coverdisplay ()
{
    MUSIC_DIR=/home/bender/Music/ #mpd music_dir
    ...
    feh -^ albumart -g 400x400 -Z "$PATH_NO_TRAIL" > /dev/null 2&>1
